...
$con= mysqli_connect('egon.cs.umn.edu','C4131F16U35','3447','C4131F16U35','3307');
// Check connection
...
mysqli_query($con,"INSERT INTO tbl_accounts (acc_name, acc_login, acc_password) VALUES ('Mingzhe Huang', 'DaHuang', '". sha1($str2)."');");
